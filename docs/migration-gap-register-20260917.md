...
Fresh read-only cloud ledger audit: LOCAL 94, STAGING 59, PRODUCTION 28.
...
| Migration | Missing on | Domains | Apply-time data / destructive risk | SHA-256 |
|---|---|---|---|---|
...
| `20260915181000_payroll_history_guards.sql` | PRODUCTION | security, payroll | DDL/RPC; review | `606d85dca27a345315116cad258931f7d503e52a639be178562e91b02175d09e` |
| `20260915190000_security_rpc_surface.sql` | PRODUCTION | security | DDL/RPC; review | `5491322391f45488793c47531eace43ce795b485cbac555c1ba4f7cd260fbc32` |
| `20260915191000_authorization_foundation.sql` | PRODUCTION | security | metadata; review | `65e104542c928a1ab3cbdf7e81823290874ed1b00e06e0e9ef15a5ce0ff9b15a` |
| `20260915192000_security_unused_grants.sql` | PRODUCTION | security | DDL/RPC; review | `fa4b13e1d5999606915a67e5e44b18938c278d3678533f00751cd04224e3cfb7` |
| `20260915200000_branch_relationship_scope.sql` | PRODUCTION | security | metadata; review | `0cfdbd87f176a44fd7ca43c84a1de8facc51efabde5882db8f24a66802547135` |
| `20260916090000_harden_payroll_self_read.sql` | PRODUCTION | security, payroll | DDL/RPC; review | `752c5e129f9e4d294836980c17241c9f2d639ec137365d6af2a9e4af4e626481` |
| `20260916091000_harden_feedback_respondent_authorization.sql` | PRODUCTION | security | metadata; review | `174dac7ddbc3620c019712893ae70a92f5a30dfa328cb4bdb49a3ac262f9c99a` |
| `20260916092000_align_relationship_read_authorization.sql` | PRODUCTION | security | DDL/RPC; review | `fc06f90f458b12fbb15a364010047c3b87501b59c2e381e3c62f994b8f7b3385` |
| `20260916093000_bound_teacher_historical_access.sql` | PRODUCTION | security | DDL/RPC; review | `66f68a6e24509d46fd1cba27b06f501a4afe29369b95fb1f31f7244a8a8ccc7b` |
| `20260916094000_student_parent_history_reads.sql` | PRODUCTION | security | metadata; review | `11745c8db106dfddec23187d6ee781b6c47a2bb4c2b6bcb14d5c6c1f8d951978` |
| `20260916095000_scoped_finance_payroll_reads.sql` | PRODUCTION | security, finance, payroll | metadata; review | `91de3552fd641c412b220d493803cbaa03c005c59506a0ca1890f7d69471132e` |
| `20260916100000_payroll_maker_checker.sql` | PRODUCTION | security, payroll | metadata; review | `425b7e72dfbd4251f478648d1787d032617c7c8a9d57ea4494255da7ca917653` |
| `20260916110000_financial_approval_workflows.sql` | PRODUCTION | security, finance | metadata; review | `355d7c4ee1799de566143cd94d4e522deaf5126969cb560ac62e0ea48f2bcf33` |
| `20260916111000_invoice_cancellation_approval.sql` | PRODUCTION | security, finance | metadata; review | `b1b24514f80420c16011c1c69a3974e03884be3dbc7ce2c2eec9e748af0b4c41` |
| `20260916120000_security_consistency_hardening.sql` | PRODUCTION | security | DDL/RPC; review | `3e6207096fb2f4dd599caaa2ff5aa74a94a277c1f44649a6397585d92fa204a8` |
...
| `20260916183000_payroll_employee_self_read.sql` | STAGING/PRODUCTION | security, payroll, HR | DDL/RPC; review | `c284e5ef9ea7f6321095cb1db71994e5d1f4f7dcb0ae6e3dbd0ec95163d4ed68` |
...
| `20260916190000_parent_finance_visibility.sql` | STAGING/PRODUCTION | security, finance | DDL/RPC; review | `795a67c565e5b2f6ee95ba2662608c9de4033c71937887192455bfe6ea5ea4fa` |
| `20260916191000_family_portal_projections.sql` | STAGING/PRODUCTION | security | DDL/RPC; review | `34ea6daa863b159cc7b7e7739601d9de243ed8a3f0a49385f0007d4705d111e3` |
| `20260916192000_family_academic_permission.sql` | STAGING/PRODUCTION | security | metadata; review | `3df6589024e7af344fa9cec9f8dc735836a6839ac508f3f84081cd10a978cda7` |
| `20260916193000_teacher_portal_reads.sql` | STAGING/PRODUCTION | security | metadata; review | `ccc068e45224db4b6533b7fc4eb2ddb1e5a0a539119b6abb56b8559060a16d95` |
...
| `20260916195000_teacher_current_academic_reads.sql` | STAGING/PRODUCTION | security | metadata; review | `2a9d08ea41a39b4a16eb257adcaad70fa1491222ea661370f32a45d41bc9ed73` |
| `20260916200000_payroll_effective_employee_self_read.sql` | STAGING/PRODUCTION | security, payroll, HR | DDL/RPC; review | `bb131c3f055f8132581a1917c2105e996eea002346f2e278147ab9c764022c0f` |
| `20260916201000_teacher_attendance_projection.sql` | STAGING/PRODUCTION | security | DDL/RPC; review | `e35b520d13e9c7c91adba23fc34261c0556ed7f5127f8f775738932ec2cb67c0` |
...
| `20260916221000_inventory_catalogue_scope.sql` | STAGING/PRODUCTION | security, inventory | DDL/RPC; review | `2dde43b0476f49016f95128a0c40ce76c664b2fa68029401043dc8f9056d0742` |
...
| `20260917020000_revoke_anonymous_business_grants.sql` | STAGING/PRODUCTION | security | DDL/RPC; review | `b0d864b9e28766b12f2238216203e3d887490974b32f020afc437b36ab86cf5c` |
