...
const { data: academicRecordComponents, error: academicRecordComponentsError } =
  ...
  const isCurrentLevelScheduled =
    ...
    isAcademicScheduled(currentLevelProgress.started_at)
  ...
  >
    ...
    <div className="flex items-center justify-between gap-4 px-3 py-2.5">
      ...
      <p className="text-sm font-medium text-gray-800">
        ...
        {!item.subject.is_required && " (Tùy chọn)"}
      ...
      item.subject.completion_rule !== 'ALL_REQUIRED_COMPONENTS' ? (
        ...
        >
          ...
          <select
            ...
            defaultValue={
              ...
              academicStatuses.some(status => status === item.status)
          ...
          >
            ...
            {!academicStatuses.some(status => status === item.status) && (
              ...
              <option value="" disabled>
                ...
                {academicStatusLabel(item.status)} (historical)
        ...
        <span
          ...
          className={`shrink-0 rounded-full px-2.5 py-1 text-xs font-semibold ${
            ...
            successfulAcademicStatus(item.status)
        ...
        >
          ...
          {academicStatusLabel(item.status)}
              ...
              <div className="flex items-center gap-3">
                ...
                <p className="text-sm text-gray-600">
                  ...
                  {componentItem.component?.name ??
                    ...
                    "Học phần chưa có tên"}

                  {!componentItem.component.is_required &&
      ...
      .map((levelProgress) => {
        ...
        return (
          ...
          <details
            ...
            open={levelProgress.status === "IN_PROGRESS" && !(isAcademicScheduled(levelProgress.started_at))}
                ...
                <span
                  ...
                  className={
                    ...
                    levelProgress.status === "COMPLETED"
                      ...
                      : isAcademicScheduled(levelProgress.started_at)
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <span
                ...
                className={
                  ...
                  successfulAcademicStatus(subjectProgress.status)
              ...
              >
                ...
                {academicStatusLabel(subjectProgress.status)}
                    ...
                    >
                      ...
                      <span
                        ...
                        className={
                          ...
                          successfulAcademicStatus(componentProgress.status)
                      ...
                      >
                        ...
                        {academicStatusLabel(componentProgress.status)}
