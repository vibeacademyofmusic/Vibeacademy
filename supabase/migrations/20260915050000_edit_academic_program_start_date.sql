-- =========================================================
-- Edit Academic Program Start Date
-- =========================================================

create or replace function public.update_student_academic_enrollment_start_date(
...
revoke all
on function public.update_student_academic_enrollment_start_date(uuid, date)
from public;
...
comment on function public.update_student_academic_enrollment_start_date(uuid, date)
is
'Changes an ACTIVE academic program enrollment start date before real academic progress exists and keeps the current IN_PROGRESS level start date synchronized.';
