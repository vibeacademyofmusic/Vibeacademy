...
-- Payroll Payslip V2
--
-- Extends the existing payslip RPC so approved/finalized
-- Payroll V2 records expose their authoritative component
-- lines and active period actions.
--
-- Does not mutate payroll amounts or historical payroll data.
...
begin
  ...
  return jsonb_build_object(
    ...
    -- --------------------------------------------------
    -- Payroll V2 calculated components
    -- --------------------------------------------------
    ...
    -- --------------------------------------------------
    -- Payroll V2 period-specific items
    -- Bonus / Expense reimbursements
    -- Only ACTIVE actions affect the current payslip.
    -- --------------------------------------------------
    ...
    -- --------------------------------------------------
    -- Legacy adjustments remain visible because
    -- adjustment_amount is still part of V2 compatibility
    -- totals when such history exists.
    -- --------------------------------------------------
    ...
    -- Never reconstruct these totals from current config.
    -- --------------------------------------------------
