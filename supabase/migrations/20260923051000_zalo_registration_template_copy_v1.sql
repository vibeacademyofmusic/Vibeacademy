-- Align registration Zalo template parameters with the approved Vietnamese copy.
-- Does not enable sending. Does not set a Zalo template id.

update public.notification_templates
set
  description = 'Xác nhận đăng ký tại VIBE Academy',
  parameter_schema = '["student_name","program_name","branch_name","portal_url"]'::jsonb
